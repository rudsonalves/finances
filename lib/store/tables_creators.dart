...
class TablesCreators {
  ...
  ///
  /// The AppControl table stores key application settings and version information.
  ...
  ///
  /// The Users table stores user information including user credentials and preferences.
  /// - Parameter batch: The database batch in which the SQL command is to be executed.
  ...
  /// Creates the Accounts table and an index for user IDs using predefined SQL commands.
  ///
  /// The Accounts table stores account information for users. An index on user IDs
  /// is also created for faster query performance.
  /// - Parameter batch: The database batch in which the SQL command is to be executed.
  ...
  /// Creates the Balance table and associated indices using predefined SQL commands.
  ///
  /// The Balance table stores balance information for accounts. Indices on date and
  /// account ID are created for improved query performance.
  /// - Parameter batch: The database batch in which the SQL command is to be executed.
  ...
  ///
  /// The Category table stores transaction category information. A name index is created
  /// to enhance lookup speeds.
  /// - Parameter batch: The database batch in which the SQL command is to be executed.
  ...
  /// Creates the Transactions table and associated indices using predefined SQL commands.
  ///
  /// The Transactions table stores transaction details. Date and category indices
  /// are created for faster sorting and querying.
  /// - Parameter batch: The database batch in which the SQL command is to be executed.
  ...
  /// Creates the TransDay table using predefined SQL commands.
  ///
