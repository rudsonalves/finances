...
class _OfxPageState extends State<OfxPage> {
  ...
  Future<void> _ofxCreateTransactions({
    ...
    for (final OfxTransaction ofxTransaction in ofxTransactions) {
      ...
      bool addTransaction = await showDialog(
        context: context,
  ...
  // FIXME: falta implementar uma opção de automatização, embora o código já
  //        esteja todo pronto para isto, faltando apenas descidir como será a
  //        implementação da inteface com o usuário para acioná-la e mais alguns
