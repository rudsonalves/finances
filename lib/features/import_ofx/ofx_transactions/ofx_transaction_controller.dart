...
import 'ofx_transaction_state.dart';
...
class OfxTransactionController extends ChangeNotifier {
  ...
  OfxTransactionState _state = OfxTransactionStateInitial();
  ...
  OfxTransactionState get state => _state;
  ...
  void _changeState(OfxTransactionState newState) {
    _state = newState;
    notifyListeners();
  }
  ...
  Future<void> init(TransactionDbModel? transaction) async {
    _changeState(OfxTransactionStateLoading());
    ...
    _changeState(OfxTransactionStateSuccess());
  }
  ...
  void setCategoryByDescription(String description) {
    try {
      ...
      log('OfxTransactionController.setCategoryByDescription $err');
      _changeState(OfxTransactionStateError());
    }
  }
  ...
  void setCategoryById(int id) {
    try {
      ...
      log('OfxTransactionController.setCategoryById: $err');
      _changeState(OfxTransactionStateError());
    }
  }
