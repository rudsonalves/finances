...
- [ ] **2.1. Testes Unitários para `BalanceManager`**
...
- [ ] **2.2. Testes Unitários para `TransactionManager.addNew`**
...
- [ ] **2.3. Testes Unitários para `TransactionManager.remove`**
  - Casos de teste:
...
- [ ] **2.4. Testes Unitários para `TransferManager`**
...
- [ ] **2.5. Tornar Transações e Transferências Atômicas**
