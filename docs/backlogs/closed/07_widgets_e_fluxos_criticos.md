...
- [x] **7.1. Testes de Widgets de Entrada e Validação de Formulário**
...
- [x] **7.2. Testes de Widgets de Apresentação de Dados**
...
- [x] **7.3. Smoke Tests de Widgets com Dependências Controladas**
